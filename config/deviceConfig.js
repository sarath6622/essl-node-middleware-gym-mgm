const DEVICE_CONFIG = {
  ...
  syncInterval: 1800000, // 30 minutes (30 * 60 * 1000)
  duplicateCheckWindow: 300000, // 5 minutes (increased from 1 min to prevent rapid re-punches)
  ignoreUnknownUsers: true, // Ignore events from users not in the database
